...
export function IconBuilding2({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconChartPie({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconChartLine({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconInfoCircle({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconActivity({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconCoin({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconCurrencyDollar({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <circle cx="12" cy="12" r="10" />
      <path d="M12 6v12M9 9h6a3 3 0 0 1 0 6H9" />
    </svg>
  )
}
...
export function IconNews({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
